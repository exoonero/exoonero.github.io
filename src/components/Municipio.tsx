      ...
      <main>
        ...
        <div className="flex flex-col mt-5 mb-5">
            <p className="font-normal text-[#7C828A] 3xl:mx-auto 4xl:w-[59rem]">
              Coletamos os diários oficiais municipais publicados pela
              Associação dos Municípios Alagoanos (AMA). Escolhendo a localidade
              em um determinado período, te apresentaremos as nomeações e
          ...
          <div className="gap-x-5 gap-y-5 mx-[25%] flex flex-col xl:flex-row ">
            ...
            >
              ...
              <option value="olho-d agua-grande">
                Olho d&apos;Água Grande
              </option>
              ...
              <option value="porto-real-do-colegio">
